...
DUK_LOCAL duk_int_t duk__eval_module_source(duk_context *ctx, void *udata);
#else
DUK_LOCAL duk_int_t duk__eval_module_source(duk_context *ctx);
#endif
DUK_LOCAL void duk__push_module_object(duk_context *ctx, const char *id, duk_bool_t main);

DUK_LOCAL duk_bool_t duk__get_cached_module(duk_context *ctx, const char *id) {
 ...
 */
DUK_LOCAL void duk__put_cached_module(duk_context *ctx) {
	/* [ ... module ] */
...
DUK_LOCAL void duk__del_cached_module(duk_context *ctx, const char *id) {
	duk_push_global_stash(ctx);
	(void) duk_get_prop_string(ctx, -1, "\xff" "requireCache");
...
DUK_LOCAL duk_ret_t duk__handle_require(duk_context *ctx) {
	/*
...
DUK_LOCAL void duk__push_require_function(duk_context *ctx, const char *id) {
...
DUK_EXTERNAL duk_ret_t duk_module_node_peval_main(duk_context *ctx, const char *path) {
	/*
	 *  Stack: [ ... source ]
	 */
